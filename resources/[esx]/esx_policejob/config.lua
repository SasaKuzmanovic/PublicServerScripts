...
Config.AuthorizedVehicles = {
	Shared = {
		...
		{ model = 'police3', label = 'VW Golf MK6', price = 0 },
		{ model = 'fbi', label = 'Undercover buffalo', price = 0 },
        { model = '2015polstang', label = 'Ford Mustang GT350', price = 0 },
		{ model = 'riot', label = 'Oklopno vozilo Interventna', price = 0 },
		{ model = 'police4', label = 'Audi RS6 Avant Civilni', price = 0 },
		{ model = 'fbi2', label = 'Chevrolet Interventna', price = 0 },
		{ model = 'policeb1', label = 'Motor', price = 0 }
	},
