    ...
    while true do
        ...
        for k,v in pairs(radares) do
            ...
            if Vdist2(radares[k].x, radares[k].y, radares[k].z, x, y, z) < 60 then
                if ESX.PlayerData.job ~= nil and not (ESX.PlayerData.job.name == 'police' or ESX.PlayerData.job.name == 'ambulance') then
...
function checkSpeed()
	...
	finelevel = '40km/h iznad ogranicenja'
        ...
        exports.pNotify:SendNotification({
            text = "<h2><center>Radar</center></h2>" .. "</br>Platili ste kaznu za prebrzu voznju!</br>Tablica: " .. plate .. "</br>Iznos kazne: $" .. fineamount .. "</br>Prekrsaj: " .. finelevel .. "</br>Ogranicenje: " .. maxspeed .. "</br>Tvoja brzina: " ..mphspeed,
            type = "error",
            timeout = 9500,
            layout = "centerLeft",
            queue = "left"
