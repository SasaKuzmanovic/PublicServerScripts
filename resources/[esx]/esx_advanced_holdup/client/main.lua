		...
		if CurrentAction == nil then
			...
			if IsControlJustReleased(1,  Keys['E']) and GetLastInputMethod(2) then
				...
				if IsPedSittingInAnyVehicle(playerPed) then
					...
					if tip == 1 then
						TriggerServerEvent('pljacka:UTijeku', zone)
					elseif tip == 2 then
						if PlayerData.job.name ~= nil and (PlayerData.job.name == 'yakuza' or PlayerData.job.name == 'mafia' or PlayerData.job.name == 'cartel' or PlayerData.job.name == 'zemunski' or PlayerData.job.name == 'camorra' or PlayerData.job.name == 'shelby' or PlayerData.job.name == 'nomads' or PlayerData.job.name == 'britvasi') then
							TriggerServerEvent('pljacka:UTijeku', zone)
						else
