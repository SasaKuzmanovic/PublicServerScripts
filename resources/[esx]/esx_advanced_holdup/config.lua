...
Config.Zones = {
	...
	["24/7 Supermarket 1"] = {
		Pos				= { x = 378.77236938477, y = 332.49127197266, z = 103.56636810303 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["LTD Gasoline 2"] = {
		Pos				= { x = 1159.8839111328, y = -314.0383605957, z = 69.205055236816 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["LTD Gasoline 3"] = {
		Pos				= { x = -1828.8621826172, y = 798.96643066406, z = 138.18365478516 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["Robs Liquor"] = {
		Pos				= { x = -1479.0137939453, y = -374.45379638672, z = 39.163284301758 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["Robs Liquor 2"] = {
		Pos				= { x = -1220.1519775391, y = -915.74090576172, z = 11.326163291931 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["LTD Gasoline 4"] = {
		Pos				= { x = -709.47406005859, y = -904.24829101563, z = 19.215591430664 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["Robs Liquor 3"] = {
		Pos				= { x = -2959.4538574219, y = 387.62646484375, z = 14.043151855469 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["24/7 Supermarket 2"] = {
		Pos				= { x = -3047.5124511719, y = 587.25207519531, z = 7.9089293479919 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
	...
	["24/7 Supermarket 3"] = {
		Pos				= { x = -3248.9819335938, y = 1006.0564575195, z = 12.830711364746 },
		Size  		= { x = 1.5, y = 1.5, z = 1.0 },
		Color 		= { r = 220, g = 110, b = 0 },
		AreaSize 	= 15,
		Type  		= 1,
