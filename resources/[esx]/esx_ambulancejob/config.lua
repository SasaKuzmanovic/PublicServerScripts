...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Lijecenje = {
			vector3(308.16387939454, -595.31903076172, 42.291831970214)
		},

		Vehicles = {
			{
				Spawner = vector3(298.63037109375, -599.7211303711, 43.292057037354),
...
Config.AuthorizedVehicles = {
	...
	ambulance = {
		...
		{ model = 'f750', label = 'Ambulance Van 2', price = 5000},
