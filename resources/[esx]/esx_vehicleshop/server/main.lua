...
MySQL.ready(function()
	...
	for i=1, #vehicles, 1 do
		local vehiclea = vehicles[i]

		for j=1, #Categories, 1 do
			if Categories[j].name == vehiclea.category then
				vehiclea.categoryLabel = Categories[j].label
				break
			end
		end

		table.insert(Vehicles, vehiclea)
	end
...
ESX.RegisterServerCallback('autosalon:sealion', function (source, cb, vehicleModel)
...
ESX.RegisterServerCallback('autosalon:sealionSociety', function (source, cb, society, vehicleModel)
	local vehicleData = nil
