...
StartComputer=function()
	Citizen.CreateThread(function()
		InitializeBruteForce=function(g)
			...
			PushScaleformMovieFunctionParameterString("Lokalni Disk (Z:)")
			PushScaleformMovieFunctionParameterString("Mreza")
			PushScaleformMovieFunctionParameterString("Vanjski uredjaj (J:)")
			PushScaleformMovieFunctionParameterString("BattleCraft.exe")
			PushScaleformMovieFunctionParameterString("BruteForce.exe")
			ScaleformLabel("H_ICON_6")PopScaleformMovieFunctionVoid()
			...
			PushScaleformMovieFunctionParameterString("Moje racunalo")
			PopScaleformMovieFunctionVoid()
			PushScaleformMovieFunction(g,"ADD_PROGRAM")
			PushScaleformMovieFunctionParameterFloat(6.0)
			PushScaleformMovieFunctionParameterFloat(6.0)
			PushScaleformMovieFunctionParameterString("Gasenje")
			PopScaleformMovieFunctionVoid()
