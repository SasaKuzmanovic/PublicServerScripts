Config                            = {}
Config.Locale = 'hr' -- your language, It would be nice if you send me your translation on fivem forum
...
Config.WeedPrice = 400	-- sell price for single, not pooch (black money)
Config.MethPrice = 500	-- sell price for single, not pooch (black money)
