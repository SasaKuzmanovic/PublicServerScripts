...
spawnNotif = {
contact = "Informant",
title = "~r~Prljavi posao.",
msg = "~g~Kamion s novcem je upravo krenuo, pripremite se za pljacku."
},

copsSpawnNotif = {
contact = "Gruppe Six Agency Director",
title = "~r~Transportacija novca",
msg = "~g~Kamion s novcem je krenuo, zastitite ga!"
},

rewardnotif = {"Primili ste ~g~"," ~w~$ novca"},
onMapBlipName_truck = "Kamion s novcem",
copsOnMapBlipName_truck = "Oklopljeni kamion s novcem",
onMapBlipName_money = "Vreca Novca",
destroyedTruckNotif = "~r~Vreca novca je unistena.",
cops_notification = "Kamion s novcem je u zasjedi! ~y~",
cops_Collect_money = "~y~A Law Enforcement Officer has secured the money bag!",
cops_Veh_plate = {"~r~Info","~y~Potencijalno sumnjivo vozilo  :  ~g~","  ~y~Model :  ~g~"},
copsNoClueNofif = "~y~Nema informacija o sumnjivcima...",
