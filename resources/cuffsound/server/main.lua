...
------
RegisterServerEvent('InteractSounda_SV:PlayWithinDistance')
AddEventHandler('InteractSounda_SV:PlayWithinDistance', function(maxDistance, soundFile, soundVolume)
    TriggerClientEvent('InteractSounda_CL:PlayWithinDistance', -1, source, maxDistance, soundFile, soundVolume)
end)
