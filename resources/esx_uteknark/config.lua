Config = {
    ...
    Distance = { -- All distances in meters
        ...
        Above = 3.0,    -- How much clear space above the planting space do you need to plant?
    },
    ActionTime = 4000,   -- How many milliseconds does an action take (planting, destroying, harvesting, tending)
    ...
    Yield = {5,25}, -- How many Items.Product does each plant yield? {5,30} means "from 5 to 30, inclusive"
